...
def create_app(config_class=Config):
    ...
    with app.app_context():
        ...
        db.create_all()
        try:
            from app.enterprise.ai_document_search import _ensure_schema
            from app.enterprise.ai_chatbot_conversations import (
                _ensure_conversations_schema as _ensure_chat_schema,
            )
            from app.enterprise.ai_document_search_conversations import _ensure_conversations_schema
            from app.enterprise.ai_policy_assistant_conversations import (
                _ensure_conversations_schema as _ensure_policy_schema,
            )
        ...
        _ensure_resource_pool_resources_columns()
        try:
            from app.enterprise.intranet_routes import _normalize_security_clearance_records
