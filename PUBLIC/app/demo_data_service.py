...
_POOL_CHAT_MESSAGES: list[str] = [
    ...
    "Has anyone tested the new modules view?",
...
_POOL_ABOUT_BODY: list[dict[str, Any]] = [
    {
        ...
        "who_body": "<p>We are a demo organisation showcasing Firmgate modules: modules, documents, modules, and more.</p>",
        "links": [
...
_SECTION_POOLS: dict[str, list[Any]] = {
    ...
    "blogs": _POOL_BLOGS,
    "events": _POOL_EVENTS,
    "wiki_pages": _POOL_WIKI,    "chat_messages": _POOL_CHAT_MESSAGES,
