"""Australian public holidays for calendar overlay (VIC, ACT, NSW, SA)."""
...
AU_CALENDAR_SUBDIVS: tuple[str, ...] = ("VIC", "ACT", "NSW", "SA")
            ...
            out.append(
                {
                    ...
                    "allDay": True,
                    "location": states,
                    "notes": f"Public holiday in {states} (VIC, ACT, NSW, SA subset).",
                    "mine": False,
                    "shared_count": 0,
                    "shared_user_ids": [],
                    "shared_group_ids": [],
